...
app.layout= html.Div(
    [html.H1("VERIFICA DEI LIMITI DI PORTATA PER TIPOLOGIA DI POMPA",style =  {'text-align':'center'}),
...
html.Br(),
html.H3("Select a value for outline Pressure"),
html.Br(),
